...
public class ActorSearchActorsTypeaheadRequest extends AuthRequest implements MapRequest {

    protected ActorSearchActorsTypeaheadRequest(String accessJwt) {
        super(accessJwt);
    }
    ...
    public static final class ActorSearchActorsRequestBuilder {
        ...
        public ActorSearchActorsTypeaheadRequest build() {
            ActorSearchActorsTypeaheadRequest actorSearchActorsRequest = new ActorSearchActorsTypeaheadRequest(accessJwt);
